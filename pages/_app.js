      ...
      <div className="flex flex-col items-center min-h-screen font-[Cormorant] text-[#1C1C1C] pt-[138px]">
        <div className="flex fixed top-0 z-50 h-[138px] bg-[#f7f7f7] w-full justify-center">
          <div className="flex justify-between pl-[24px] w-[1200px] items-center h-full">
            <Link href="/">
              <h1 className="text-[20px] tracking-[.1em] uppercase">Chansy Hu</h1>
            </Link>
            <nav className="flex uppercase">
              <Link className="px-[24px] tracking-[.2em] hover:underline" href="/">
                home
              </Link>
              <span>|</span>
              <Link className="px-[24px] tracking-[.2em] hover:underline" href="/portfolio">
                portfolio
              </Link>
              <span>|</span>
              <Link className="px-[24px] tracking-[.2em] hover:underline" href="/documentary">
                documentary
              </Link>
              <span>|</span>
              <Link className="px-[24px] tracking-[.2em] hover:underline" href="/contact">
                contact
              </Link>
            </nav>
          </div>
        ...
        <footer className="flex w-full h-[136px] bg-[#f7f7f7] justify-center">
          <div className="h-full bg-[#f7f7f7] px-[24px] w-[1200px] flex items-center justify-between text-[#77817E]">
            ...
            <div className="flex items-center">
              <a className="material-symbols-outlined cursor-pointer mr-[16px]" href="mailto:chansyhuhu@gmail.com">
                mail
              </a>

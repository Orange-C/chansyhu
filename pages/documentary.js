    ...
    <>
      ...
      <div className="w-[1200px] flex mt-[60px] justify-between">
        ...
        <div className="flex flex-col justify-center w-[500px] text-center pt-[96px]">
          ...
          <p className="italic tracking-[.2em] mb-[64px]">CALIFORNIA . ULTA . Arizona . Oregon . HONGKONG . SINGGPORE . KOREA . THAILAND</p>
          <p className="tracking-[.1em]">In life, I always use a camera to record the beautiful moments happening in the world.</p>
        </div>
      </div>
      <div className="w-[1200px] grid grid-cols-3 my-[120px] gap-[32px]">
        {IMAGES.map((v, index) => <div className="flex justify-center items-center" key={index}><GalleryImage src={v} /></div>)}
      </div>
    </>
  )
}
  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center w-[600px] pb-[130px]">
        <p className="font-[Cantarell] tracking-[.2em] text-[16px] mb-[24px]">
        ...
        <p className="tracking-[.1em] text-[16px] mb-[64px] text-center">
          Creature brought darkness given itself there. And spirit fifth greater good forth have them all. Yielding have
          also
        </p>
        <Link
          className="w-[245px] h-[60px] bg-[#77817E] flex justify-center items-center text-white italic text-[18px] tracking-[.1em]"
          href="/contact"
        >
          Contact
        </Link>
